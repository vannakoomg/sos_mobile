                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          controller.listImage
                                              .removeAt(controller.index.value);
                                        },
                                        child: Container(
                                          height: 30,
                                          width: 30,
                        ...
                        AnimatedContainer(
                          height: controller.tagtext.value == "" ? 50 : 410,
                              ...
                              Row(
                                children: [
                                  if (controller.listTag.isNotEmpty)
                                    Row(
                                      children:
                                          controller.listTag.map((element) {
                                        return Padding(
                                          padding:
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      controller: controller.tagTextfield.value,
                                      onChanged: (value) {
                                        controller.tagtext.value = value;
                                        if (controller.tagtext.value.length ==
                                            1) {
                                          Future.delayed(
